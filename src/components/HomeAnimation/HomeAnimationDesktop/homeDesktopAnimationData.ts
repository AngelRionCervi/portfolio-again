...
interface HomeDesktopAnimationProps {
  doors: [string, string]
  words: [string, string]
}

export default function homeDesktopAnimation({ doors, words }: HomeDesktopAnimationProps) {
  animeInstances.push(
    window.setTimeout(() => {
...
export function stopAnimationDesktop() {
